...
export default function LaodFile() {
  return (
    <>
    <h2 class="mb-2 text-base font-semibold text-gray-900 dark:text-white">Analyzing Your Data</h2>
    <ul class="max-w-md space-y-2 text-gray-500 list-inside dark:text-gray-400 text-xs">
